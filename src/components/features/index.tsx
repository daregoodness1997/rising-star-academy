            ...
            <Card.Body>
              <Flex css={{ gap: "0.5rem" }}>
                ...
                <Flex direction={"column"}>
                  ...
                  <Text span>
                    At Rising Star, our mission is to provide a nurturing
                    ...
                    can discover their football talent and develop critical life
                    skills. Through expert coaching, mentorship, and holistic
                    development programs, we empower these children to cultivate
                    leadership, teamwork, and resilience, fostering personal
                    growth both on and off the field. Our unwavering commitment
                    is to prepare these players to make a positive impact in
                    their communities and beyond, whether they pursue a
                    professional football career or contribute to society in
